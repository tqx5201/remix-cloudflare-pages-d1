...
function get_avc1_mp4a(id){
	const CHANNEL_MAPPING = {
		...
		"4gtv-4gtv152": [1, 2],  // 東森新聞
		"4gtv-4gtv153": [1, 2],  // 東森財經新聞
		"4gtv-4gtv155": [1, 6],  // 民視
		"4gtv-4gtv156": [1, 6],  // 民視台灣台
		"litv-ftv03": [1, 7],  // 美國之音
		"litv-ftv07": [1, 7],  // 民視旅遊
		"litv-ftv09": [1, 7],  // 民視影劇
		"litv-ftv10": [1, 7],  // 半島新聞
		...
		"litv-longturn01": [4, 5],  // 龍華卡通
		"litv-longturn03": [5, 6],  // 龍華電影
		"litv-longturn04": [5, 6],  // 博斯魅力
		...
		"litv-longturn18": [5, 6],  // 龍華戲劇
		"litv-longturn19": [5, 6],  // Smart知識台
		"litv-longturn20": [5, 6],  // 生活英語台
